...
export declare const union: <C extends SelectStatement<any, any, any>, CS extends SelectStatement<any, any, any>[]>(
  ...
  | (C extends SelectStatement<infer _With, infer _Scope, infer Selection> ? Selection : never)
  | (CS[number] extends SelectStatement<infer _With, infer _Scope, infer Selection> ? Selection : never),
  C extends SelectStatement<infer _With, infer _Scope, infer Selection> ? Selection : never
>
```
